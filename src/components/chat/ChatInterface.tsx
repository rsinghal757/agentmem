    ...
    <div className="app-shell">
              ...
              <Button
                ...
                className={cn(
                  ...
                  thread.id === activeThreadId
                    ? "border-[color-mix(in_oklab,var(--brand),var(--background)_76%)] bg-[var(--brand-softer)] hover:bg-[var(--brand-softer)]"
      ...
      <div className="workspace-panel flex h-full flex-col overflow-hidden">
        <div className="workspace-header">
          <div className="flex min-w-0 items-center gap-3">
            <Button type="button" onClick={() => setIsHistoryOpen(true)} variant="outline" size="icon" className="h-9 w-9 shrink-0 bg-card/80 lg:hidden" aria-label="Open history">
          ...
          {messages.length > 0 ? (
            ...
            <Badge variant="secondary" className="hidden px-2.5 text-primary-text sm:inline-flex">Ready</Badge>
          )}
        </div>
